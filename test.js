...
test('should add links to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[1\.1\.0] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/release-it\/release-it\/compare\/1\.1\.0\.\.\.HEAD\n\[1\.1\.0]: https:\/\/github\.com\/release-it\/release-it\/compare\/1\.0\.0\.\.\.1\.1\.0\n\[1\.0\.0]: https:\/\/github\.com\/release-it\/release-it\/compare\/0\.0\.0\.\.\.1\.0\.0\n$/
  );
});
...
test('should add links with custom URL formats to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[1\.1\.0] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/_git\/release-it\/release-it\/compareBranch\/1\.1\.0\/HEAD\n\[1\.1\.0]: https:\/\/github\.com\/_git\/release-it\/release-it\/compareBranch\/1\.0\.0\/1\.1\.0\n\[1\.0\.0]: https:\/\/github\.com\/_git\/release-it\/release-it\/compareBranch\/0\.0\.0\/1\.0\.0\n$/
  );
});
...
test('should add links with custom head to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[1\.1\.0] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/release-it\/release-it\/compare\/1\.1\.0\.\.\.main\n\[1\.1\.0]: https:\/\/github\.com\/release-it\/release-it\/compare\/1\.0\.0\.\.\.1\.1\.0\n\[1\.0\.0]: https:\/\/github\.com\/release-it\/release-it\/compare\/0\.0\.0\.\.\.1\.0\.0\n$/
  );
});
...
test('should add unreleased section and links to the end of the file', async t => {
  ...
  assert.match(
    ...
    /^## \[Unreleased]\n\n## \[1\.1\.0] - [0-9]{4}-[0-9]{2}-[0-9]{2}\n\n\* Item A\n\* Item B\n\n## \[1\.0\.0] - 2020-05-02\n\n\* Item C\n*\* Item D\n\n\[unreleased]: https:\/\/github\.com\/user\/project\/compare\/1\.1\.0\.\.\.HEAD\n\[1\.1\.0]: https:\/\/github\.com\/user\/project\/compare\/1\.0\.0\.\.\.1\.1\.0\n\[1\.0\.0]: https:\/\/github\.com\/user\/project\/compare\/0\.0\.0\.\.\.1\.0\.0\n/
  );
});
...
// not supported: injecting increment to the config
